...
bool Welcome::init()
{
	...
	auto startItem = MenuItemImage::create(
		"StartNormal.png",
		"StartSelected.png",
		CC_CALLBACK_1(Welcome::enterGameScene, this));
...
void Welcome::enterGameScene(Ref *pSender)
{
	//使用Director类实现场景的跳转 
	// Director::getInstance()->end();  
...
Vector<SpriteFrame*> Welcome::getAnimation(const char* sheetPlistName, const char* format, int count)
{
